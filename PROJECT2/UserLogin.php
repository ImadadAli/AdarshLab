<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      $sql = "Select *from user_login where Email='$eml' and Password='$Password'";
...
<body>
    ...
    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll ulmain" style="--bs-scroll-height: 100px;">
          ...
          <li class="nav-item dropdown lia">
            ...
            <ul class="dropdown-menu bg-dark ">
              <li><a class="nav-link active" style="color:white;" href="#">User Login</a></li>
              <li><a class="nav-link active" style="color:white;" href="AdminLogin.php
              ">Admin Login</a></li>
  ...
  ?>     
  <div> 
    <form action="UserLogin.php" class="uform" method="POST">
      <h1>User Login</h1>
     <h4> Use your Adarsh Lab account</h4>
     <input type="text" placeholder="Enter User Name" name="Email" name="UserName"><br>
      ...
      <button class="btn">Log In</button> <a href="Sign.php">Sign Up?</a><br>
    </form>
  </div>
