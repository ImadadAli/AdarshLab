<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if(($Mobile != "") && (strlen($Mobile) == 10) && ($Hospital != null) && ($Address != null)){
      $sql = "INSERT INTO `hospital_visit` (`Surname`, `Name`, `Age`, `Cases`, `Room_No`, `Doctor_Name`, `Hospital_Name`, `Email`, `Mobile_No`, `Address`) VALUES ('$SurName', '$Name', '$Age', '$Cases', '$Room', '$Doctor', '$Hospital', '$Mail', '$Mobile', '$Address')";
...
<body>
  ...
  <div> 
    <form action="Hospitalform.php" class="uform" method="POST">
     ...
     <h4>Feel the following details</h4>
      ...
      <input type="text" placeholder="Enter Your Room Number" name="Room"><br>
      <input type="text" placeholder="Enter Your Doctor Name" name="Doctor"><br>
      <input type="text" placeholder="Enter Your Hospital Name" name="Hospital"><br>
